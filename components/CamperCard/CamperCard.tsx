      ...
      <div className="flex flex-col flex-1 gap-6 min-w-0 overflow-hidden">
        ...
        <div className="flex flex-wrap gap-2">
          {badges.map((label) => (
            <span
              key={label}
              className="inline-flex items-center h-12 px-[18px] py-3 rounded-full bg-[var(--badges)] mix-blend-multiply text-base font-medium text-[var(--main)] whitespace-nowrap"
            >
              {label}
            </span>
          ))}
